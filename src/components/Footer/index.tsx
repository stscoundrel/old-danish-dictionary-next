    ...
    <footer className={styles.section}>
      <div className="container">
        <ContentArea>
          <h2>About</h2>
          <p>
            Based on &quot;Ordbog til det ældre danske Sprog&quot; by Otto
            Kalkar.
          </p>
          <p>
            It is the largest Old Danish dictionary. The original volumes were
            published in 1881 - 1907, with additional supplement added in 1907 -
            1918.
          </p>
        </ContentArea>
        ...
        <ContentArea>
          ...
          <p>
            Old Danish developed from Old East Norse, the eastern dialect of Old
            Norse, at the end of the Viking Age.
          </p>

          <p>
            Despite its name, Kalkars dictionary is not exactly a dictionary of
            &quot;Old Danish&quot;,as it covers period from Middle Danish to
            early Modern Danish. The dictionary covers time period of 1300 -
            1700, which means the oldest vocabulary would not differ much from
            that used in the Viking Age, while the newest portions would not
            differ much from modern Danish.
          </p>
        </ContentArea>
