...
describe('SEO / meta tags tests', () => {
  const words: DictionaryEntry[] = [
    {
      headword: 'Grønfugl',
      definitions: ['no. totanus. Moth. Smlgn. grittue.'],
      slug: 'gronfugl',
    },
    {
      headword: 'Grønfugl 2',
  ...
  test('Handles "letter" seo fields', () => {
    const expected = {
      ...
      description:
        'Meanings of Old Danish words starting with "G", such as grønfugl, grønfugl 2, grønfugl 3 and grønfugl 4',
    };
    const letter = {
      letter: 'g',
      slug: 'g',
  ...
  test('Handles default response', () => {
    const expected = {
      ...
      description:
        '45 000+ words and definitions for old, middle and early modern danish.',
    };
