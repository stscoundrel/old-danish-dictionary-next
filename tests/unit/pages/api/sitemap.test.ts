...
describe('Sitemap  API endpoint', () => {
  test('Should return xml sitemap', async () => {
    ...
    expect(res._getData().includes('<url><loc>https://old-danish-dictionary.test/word/abe</loc><changefreq>monthly</changefreq><priority>0.8</priority></url>')).toBeTruthy() // eslint-disable-line
  })
})
